# Accelerator Deployments — Delete
...
| `deploymentName` | path | Yes | `string` | The name of the accelerator deployment to delete. |
...
poller = cog.accelerator_deployments.begin_delete(
